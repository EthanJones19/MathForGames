...
namespace MathForGames2D
{
    class Enemy2 : Actor
    {
        ...
        public Enemy2(float x, float y, char icon = ' ', ConsoleColor color = ConsoleColor.White)
            : base(x, y, icon, color)
        {

        }

        public Enemy2(float x, float y, Color rayColor, char icon = ' ', ConsoleColor color = ConsoleColor.White)
        ...
        {
            LocalPosition = new Vector2(11, 10);
        }
    }
}
